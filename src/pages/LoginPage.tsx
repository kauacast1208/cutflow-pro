...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    ...
    console.info("[Auth] Google login clicked → lovable.auth.signInWithOAuth('google')");
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-primary relative items-center justify-center p-12">
        ...
        <div className="relative z-10 text-primary-foreground max-w-md">
          ...
          <h2 className="text-3xl font-bold mb-4 leading-tight">
            Gerencie sua barbearia com eficiência profissional.
          </h2>
          <p className="text-primary-foreground/80 text-lg leading-relaxed">
            Agenda, clientes, financeiro e muito mais em um só lugar.
          </p>
