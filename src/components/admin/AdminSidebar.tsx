...
const items: MenuItem[] = [
  ...
  { title: "CRM", url: "/dashboard/crm", icon: HeartHandshake, feature: "crm_enabled", roles: ["owner", "admin"], group: "crm" },
  { title: "Clientes Inativos", url: "/dashboard/inactive-clients", icon: UserX, feature: "crm_enabled", roles: ["owner", "admin"], group: "crm" },
  { title: "Aniversariantes", url: "/dashboard/birthdays", icon: Cake, feature: "crm_enabled", roles: ["owner", "admin"], group: "crm" },
  { title: "Retenção", url: "/dashboard/retention", icon: Heart, feature: "crm_enabled", roles: ["owner", "admin"], group: "crm" },
  { title: "Fidelidade", url: "/dashboard/loyalty", icon: Trophy, feature: "crm_enabled", roles: ["owner", "admin"], group: "crm" },
  { title: "Indicações", url: "/dashboard/referrals", icon: Gift, feature: "crm_enabled", roles: ["owner", "admin"], group: "crm" },
