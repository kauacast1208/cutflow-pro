...
const faqs = [
  ...
  { q: "Preciso instalar algo?", a: "Não. Hoje o CutFlow funciona direto no navegador. Você pode acessar pelo celular, tablet ou computador, sem instalar nada. Em breve, a experiência também poderá evoluir para formato de app." },
  ...
  { q: "Posso testar antes de pagar?", a: "Sim! Você tem 15 dias grátis com acesso total a todas as funcionalidades. Não pedimos cartão de crédito para iniciar o teste." },
