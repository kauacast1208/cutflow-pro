        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
          {screens.map((screen, i) => (
            <motion.div
              ...
              className="rounded-2xl border border-border bg-card shadow-card overflow-hidden hover:shadow-elevated transition-all duration-300"
            >
              {/* Screen header */}
              ...
              <div className="p-5">
                ...
                <div className="space-y-2">
                  {screen.mockRows.map((row, j) => (
                    <div key={j} className="flex items-center gap-2.5 rounded-lg border border-border bg-background px-3.5 py-2.5 text-xs text-muted-foreground">
