...
const testimonials = [
  {
    ...
    content: "O CutFlow organizou totalmente nossa agenda. As faltas diminuíram e os clientes adoram os lembretes automáticos.",
    rating: 5,
  },
  {
    ...
    content: "As faltas diminuíram muito desde que começamos a usar. O índice caiu mais de 30% no primeiro mês.",
    rating: 5,
  },
  {
    ...
    content: "Agora conseguimos controlar clientes e horários fácil, sem papel e sem confusão. Sistema simples e eficiente.",
    rating: 5,
  },
  {
    ...
    content: "Meus barbeiros acessam a agenda pelo celular. O controle financeiro melhorou demais com os relatórios.",
    rating: 5,
  },
  {
    ...
    content: "A página de agendamento online trouxe clientes novos toda semana. O retorno foi quase imediato.",
    rating: 5,
  },
  {
    ...
    content: "Trocamos a agenda de papel pelo CutFlow e nunca mais tivemos conflito de horário. A equipe agradeceu.",
    rating: 5,
  },
];
