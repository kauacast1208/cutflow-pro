...
export function Footer() {
  return (
    <footer className="border-t border-border bg-muted/30 dark:bg-card/40 py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="border-t border-border pt-6 sm:pt-8 flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4">
          ...
          <div className="flex gap-4 sm:gap-5">
            <a href="#" className="text-xs text-muted-foreground hover:text-primary transition-colors font-medium">Instagram</a>
            <a href="#" className="text-xs text-muted-foreground hover:text-primary transition-colors font-medium">LinkedIn</a>
            <a href="#" className="text-xs text-muted-foreground hover:text-primary transition-colors font-medium">YouTube</a>
          </div>
        </div>
      </div>
    </footer>
